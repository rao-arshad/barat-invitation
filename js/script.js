...
function setupCountdown() {
  ...
  // January 31st, 2026, 17:00 PKT (Pakistan Standard Time, UTC+5)
  const eventDate = createDateInPKT(2026, 1, 31, 17, 0, 0);
...
function setupCalendarButtons() {
  ...
  buttons.forEach((button) => {
    button.addEventListener("click", () => {
      ...
      switch (type) {
        case "Barat": {
          title = "Barat Ceremony - Muhammad Arshad Irshad";
          description =
            "Barat Ceremony of Muhammad Arshad Irshad with Daughter of Rao Muhammad Sarwar. IN SHA ALLAH.";
          location = "House No 183/3, Street No 3, Lalazar colony, Vehari";
          // January 31st, 2026, 17:00 PKT - Sehra Bandi at 5pm, Departure at 6pm
          start = createDateInPKT(2026, 1, 31, 17, 0, 0);
          end = createDateInPKT(2026, 1, 31, 21, 0, 0);
          break;
        }
        default:
          return;
...
function setupCountdown() {
  ...
  const eventDate = createDateInPKT(2026, 1, 31, 0, 0, 0);
